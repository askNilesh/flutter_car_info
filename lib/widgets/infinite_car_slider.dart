...
class CarSliderPageView extends StatefulWidget {
...
class _InfinityPageViewState extends State<CarSliderPageView> {
  ...
  @override
  void didUpdateWidget(CarSliderPageView oldWidget) {
